...
public class Loader2 : MonoBehaviour {
	...
	void OnEnable() {
		...
		{
			this.transform.FindChild ("toScale").FindChild ("man").GetComponent<RectTransform> ().localPosition = new Vector3 (30, 0, 0);
				
		} else 
		{
			this.transform.FindChild ("toScale").FindChild ("man").GetComponent<RectTransform> ().anchoredPosition = new Vector3 (-50, 0, 0);
